/********************************************************
 *
 * Custom Javascript code for Curri Ghost theme
...
$(document).ready(function() {
  ...
  // --------------------------------
  $('.post-list-options a').each(function() {
    if ($('.timeline').hasClass($(this).data('value'))) {
      $('.post-list-options a').removeClass('active');
      $(this).addClass('active');
    }
    
    $(this).on('click', function() {
      $('.timeline').attr('class', 'timeline').addClass($(this).data('value'));
      $('.post-list-options a').removeClass('active');
      $(this).addClass('active');
      return false;
    });
  ...
  $('[data-toggle=infinitescroll]').each(function() {
    ...
    function(newElements){
      $(newElements).filter(":odd, :last").after('<div class="clearfix"></div>');
      ...
      $(newElements).find('img').each(function(){
        var Retina = new RetinaImage(this);
        Retina += 1;
      });
