...
if (process.env.MYSQL_DB_HOST != undefined) {
    config = {
        ...
        production: {
            url: process.env.BLOG_URL || 'http://localhost:8089' ,
            mail: {},
            database: {
                client: 'mysql',
                connection: {
                    ...
                    password : process.env.MYSQL_DB_PASSWORD || 'mt4czpcprrec',
                    database : process.env.APP_NAME || 'tangituru',
                    charset  : 'utf8'
                }
                },
            server: {
                ...
                port: process.env.NODEJS_PORT || '8089'
            },
            paths: {
